...
func myIdentifier(state : Int, char : Character) -> Int{
...
//
func intConstatnt(state : Int, char : Character) -> Int{
...
func stringConstatnt(state : Int, char : Character) -> Int{
...
func floatConstatnt(state : Int, char : Character) -> Int{
...
//
func charConstatnt(state : Int, char : Character) -> Int{
...
func DFAParsing(inputStr : String, trasitionFunction: (Int,Character) -> Int, finalStates: [Int]) -> Bool{
